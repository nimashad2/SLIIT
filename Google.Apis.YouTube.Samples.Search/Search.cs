  ...
  internal class Search
  {
    ...
    static void Main(string[] args)
    {
      ...
      Console.ReadKey();
        ...
        //  searchListRequest.Q = "SLIIT"; // Replace with your search term.
        //  searchListRequest.MaxResults = 50;
        //  searchListRequest.PageToken = "CDIQAA";
        ...
        private async Task Run()
        {
            ...
            req.VideoId = "XCgk50WY2nc"; //-- youtube video id77
            ...
            string jStrng = JsonConvert.SerializeObject(result);

            RootObject obj = JsonConvert.DeserializeObject<RootObject>(jStrng);
